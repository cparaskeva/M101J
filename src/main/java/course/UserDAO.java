...
public class UserDAO {
    ...
    public boolean addUser(String username, String password, String email) {
        ...
        Document user = new Document("_id",username).append("username",username).append("password", passwordHash);
    ...
    public Document validateLogin(String username, String password) {
       ...
       user = usersCollection.find(new Document("username",username)).first();
